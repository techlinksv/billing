...
function Ot() {
  var t2 = Et(), n2 = t2.pagination, e2 = n2.server, r2 = n2.summary, o2 = void 0 === r2 || r2, i2 = n2.nextButton, u2 = void 0 === i2 || i2, s2 = n2.prevButton, a2 = void 0 === s2 || s2, l2 = n2.buttonsCount, c2 = void 0 === l2 ? 3 : l2, f2 = n2.limit, p2 = void 0 === f2 ? 10 : f2, d2 = n2.page, h2 = void 0 === d2 ? 0 : d2, _2 = n2.resetPageOnUpdate, m2 = void 0 === _2 || _2, v2 = yt(null), g2 = vt(h2), y2 = g2[0], b2 = g2[1], x2 = vt(0), k2 = x2[0], N2 = x2[1], C2 = Lt();
  gt(function() {
...
var Gt = function(t2) {
  ...
  return i2.adjustWidth = function(t3, n2, r2) {
    ...
    for (var r2, o3 = s(n2); !(r2 = o3()).done; ) {
      var i3 = r2.value;
      void 0 !== i3.plugin && t3.add(e({ id: i3.id }, i3.plugin, { position: qt.Cell }));
    }
...
var Qt = "undefined" != typeof Symbol ? Symbol.iterator || (Symbol.iterator = Symbol("Symbol.iterator")) : "@@iterator";
...
var gn = function(t2, n2, r2) {
  return function(o2) {
    ...
    return e({}, o2, i2 ? vn(t2, 1 === i2.direction ? -1 : 1, n2, r2)(o2) : vn(t2, 1, n2, r2)(o2));
  };
};
var yn = function(t2) {
  function o2() {
...
function bn(t2) {
  ...
  var d2 = function() {
    var t3 = K.Sort;
    return p2 && "object" == typeof p2.server && (t3 = K.ServerSort), 0 === n2.pipeline.getStepsByType(t3).length ? t3 === K.ServerSort ? new yn(e({ columns: c2 ? c2.columns : [] }, p2.server)) : new mn({ columns: c2 ? c2.columns : [] }) : null;
  };
...
function xn(t2) {
  ...
  }, rowSpan: t2.rowSpan > 1 ? t2.rowSpan : void 0, colSpan: t2.colSpan > 1 ? t2.colSpan : void 0 }, (a2 = t2.column) ? "function" == typeof a2.attributes ? a2.attributes(null, null, t2.column) : a2.attributes : {}, l2() ? { tabIndex: 0 } : {}), w("div", { className: nt("th", "content") }, void 0 !== t2.column.name ? t2.column.name : void 0 !== t2.column.plugin ? w($t, { pluginId: t2.column.plugin.id, props: { column: t2.column } }) : null), l2() && w(bn, e({ index: t2.index }, t2.column.sort)), t2.column.resizable && t2.index < n2.header.visibleColumns.length - 1 && w(wn, { column: t2.column, thRef: r2 }));
}
function kn() {
...
//# sourceMappingURL=chunk-YEFOOKYN.js.map
